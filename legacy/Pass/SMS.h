...
//
//===----------------------------------------------------------------------===//
#ifndef LLVM_LIB_CODEGEN_SMS_H
#define LLVM_LIB_CODEGEN_SMS_H
...
namespace llvm
{
    ...
    class SMS : public MachineFunctionPass
    {
    public:
    ...
    public:
        SwingSchedulerDAG(SMS &P, MachineLoop &L, LiveIntervals &lis,
